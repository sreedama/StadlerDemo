...
##
# Project:       T4S
# @file           sap_call_function_MPE_VERSNBOM_CHANGE_STATUS.tcl
##
# jw, 20040530
...
::TestScript::setScriptDesc "SAP call generic function (MPE_VERSNBOM_CHANGE_STATUS)"
...
# MPE_VERSNBOM_CHANGE_STATUS PARAMETER.
set ::SAPDat(VERSNBOM:PARAMETER:IV_NEW_STATUS) "99" ; # New Status
set ::SAPDat(VERSNBOM:PARAMETER:IV_NO_COMMIT) "X" ; # X = No Commit / " " = Commit

# IS_BOM_VERSN->BOM Version Identifier.
set ::SAPDat(VERSNBOM:IS_BOM_VERSN:MATNR) "000000000000008177" ; # Material
set ::SAPDat(VERSNBOM:IS_BOM_VERSN:WERKS) "" ; # Plant
set ::SAPDat(VERSNBOM:IS_BOM_VERSN:STLAN) "E" ; # BOM Usage
set ::SAPDat(VERSNBOM:IS_BOM_VERSN:STLAL) "05" ; # Alternative BOM
set ::SAPDat(VERSNBOM:IS_BOM_VERSN:BOM_VERSN) "0002" ; # BOM Version
set ::SAPDat(VERSNBOM:IS_BOM_VERSN:STLNR) "" ; # Bill of Material
