...
export let setSelectedTypeSelectionJs = function (data) {
    ...
    if (selectedType && selectedType.length > 0) {
        ...
        data.mat1RefParamName.dbValue = selectedType[0].props.object_name.dbValues[0];
        data.mat1RefParamName.dispValue = selectedType[0].props.object_name.uiValues[0];
		
	data.mat1RefParamUnit.dbValue = selectedType[0].props.mat1UnitAliasName.dbValues[0];
        data.mat1RefParamUnit.dispValue = selectedType[0].props.mat1UnitAliasName.uiValues[0];
...
export let createAndAddReferenceParameter = function (data, ctx) {
    ...
    var selectedMetaParam = data.dataProviders.performSearch.selectedObjects;
    if (selectedMetaParam && selectedMetaParam.length > 0) {		
		metaparam = {
			uid: selectedMetaParam[0].uid,
			type: selectedMetaParam[0].type
		};
    }
    ...
    if (data.mat1RefDataType.dbValue === 'String') {
        ...
        tagObj['mat1MetaParameter'] = metaparam;
    } else {
	...
	if(data.mat1RefParamValueMax.dbValue !== '')
