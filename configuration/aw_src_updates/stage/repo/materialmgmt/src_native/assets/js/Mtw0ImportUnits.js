 ...
 */
export let activateImportUnitsPanel = function( commandId, location ) {
...
export let importUnits = function(data){
...
export default exports = {
    activateImportUnitsPanel,
    importUnits
};

app.factory( 'Mtw0Importunits', () => exports);
