...
/**
 * @module js/Mtw0ShowAddMetaParameterService
 */
import app from 'app';
 ...
 */
export let activateShowAddMetaParameterPanel = function(commandId, location, data, ctx, objectSetSource) {
    var inputData = [];
...
export let populateListBoxes = function(data) {
    ...
    soaSvc.post('IMM-2018-12-AWCMaterialMgmtService', 'getMetaParamDetails', {}).then(
        ...
        if (response && response.dimensions) {
            ...
            var dimensions = [];
            data.xdimensions.type = "STRING";
            data.ydimensions.type = "STRING";
            ...
            for (var i in response.dimensions) {
                ...
                data.xdimensions.dbValue.push(dimensionEntry);
                data.ydimensions.dbValue.push(dimensionEntry);
            }
        }
...
export default exports = {
    activateShowAddMetaParameterPanel,
...
app.factory( 'Mtw0ShowAddMetaParameterService', () => exports);