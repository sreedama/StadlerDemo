...
if defined TC_USER_LIB goto START_PROCESS
...
:START_PROCESS
set TARGET_DIR=%TC_ROOT%\bin
if defined TC_USER_LIB set TARGET_DIR=%TC_USER_LIB%

echo Starting copy files to %TARGET_DIR%...
copy /y server\tc_root\common\bin %TARGET_DIR%
echo.
exit /B %ERRORLEVEL%
