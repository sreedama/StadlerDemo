...
echo The currently selected environment is Test environment, is this correct?
...
REM Import site specific site preferences for TST
echo.
echo preferences_manager %CREDENTIALS_TMP% -mode=import -file=preferences\site_preferences_TST.xml -scope=SITE -action=OVERRIDE
preferences_manager %CREDENTIALS% -mode=import -file=preferences\site_preferences_TST.xml -scope=SITE -action=OVERRIDE
