...
echo The currently selected environment is local development VM, is this correct?
...
echo.
echo preferences_manager %CREDENTIALS_TMP% -mode=import -file=preferences\site_preferences_Demo_VM.xml -scope=SITE -action=OVERRIDE
preferences_manager %CREDENTIALS% -mode=import -file=preferences\site_preferences_Demo_VM.xml -scope=SITE -action=OVERRIDE
