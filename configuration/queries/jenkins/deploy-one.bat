...
@echo Deploying Query %~2 ... >> %ST4_DEPLOY_LOGFILE%
::cmd /C plmxml_import -import_mode=overwrite -xml_file="%~2" %%ST4_TC_LOGIN%%
set command=plmxml_import -import_mode=overwrite -xml_file="%~2"
echo %command%
