...
rem
rem  2. The Microsoft Visual Studio 2012 Update 1 or later (MSVC++) runtime libraries
rem     must be installed before running the TcVis installer.   If you run the TcVis
rem     installer by invoking 'setup.exe' this will be automatically installed for you.
...
rem       ..\ISSetupPrerequisites\VS2012U1\vcredist_x64.exe /quiet
rem
rem --------------------------------------------------------------------
setlocal
...
rem --------------------------------------------------------------------
set INSTALLDIR=C:\Program Files\Siemens\Teamcenter11.2\Visualization
...
rem set OPTIONS=%OPTIONS% LICENSE_TYPE=2 SERVER_NAME=hostname SERVER_PORT=port
...
rem --------------------------------------------------------------------
set OPTIONS=%OPTIONS% INSTALL_SPANISH=1
set OPTIONS=%OPTIONS% INSTALL_GERMAN=1
set OPTIONS=%OPTIONS% INSTALL_FRENCH=1
set OPTIONS=%OPTIONS% INSTALL_ITALIAN=1
set OPTIONS=%OPTIONS% INSTALL_JAPANESE=1
set OPTIONS=%OPTIONS% INSTALL_KOREAN=1
set OPTIONS=%OPTIONS% INSTALL_SCHINESE=1
set OPTIONS=%OPTIONS% INSTALL_TCHINESE=1
