...
rem       ..\ISSetupPrerequisites\VS2013\vcredist_x86.exe /quiet
rem     Detection (_x64):
...
rem       To launch the 64-bit redist installer this command may be used:
rem       ..\ISSetupPrerequisites\VS2013\vcredist_x64.exe /quiet
rem
...
rem     Installation:
rem       To launch the 64-bit redist installer this command may be used:
rem       ..\ISSetupPrerequisites\VS2015\vc_redist.x64.exe /quiet
rem
rem --------------------------------------------------------------------
setlocal
...
rem set FEATURES=%FEATURES%VVBase,
rem set FEATURES=%FEATURES%VVBase_2d_ug,
rem set FEATURES=%FEATURES%VVBase_3d,
rem set FEATURES=%FEATURES%VVBase_ecad,
