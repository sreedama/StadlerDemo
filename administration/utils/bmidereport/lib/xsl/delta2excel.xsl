...
<xsl:stylesheet xmlns:plm="http://www.plmxml.org/Schemas/PLMXMLSchema"
	...
	<xsl:variable name="sColID19">19</xsl:variable>
...
<xsl:template name="extractDatasetTypes">
		...
		<xsl:variable name="sTitleID2">named reference</xsl:variable>
		<xsl:variable name="sTitleID3">extension</xsl:variable>
		<xsl:variable name="sTitleID4">format</xsl:variable>
		<xsl:variable name="sTitleID5">template</xsl:variable>
		...
		<xsl:element name="Worksheet">
			...
			<xsl:element name="Table">
				...
				<xsl:for-each
					select="//child::*/child::*/child::*[local-name() = 'TcDatasetReference']/child::*[local-name() = 'TcDatasetReferenceInfo']">
					...
					<xsl:element name="Row">
						...
						<xsl:call-template name="generateTableCell">
							<xsl:with-param name="pColumn" select="$sColID5" />
							<xsl:with-param name="pContent" select="parent::*/parent::*/parent::*/@name" />
							<xsl:with-param name="pDataType" select="$sDataType" />
						</xsl:call-template>
					</xsl:element>
				</xsl:for-each>
	...
	<xsl:template name="extractTypes">
		...
		<xsl:variable name="sTitleID4">mode</xsl:variable>
		<!-- end declarations -->
		<xsl:element name="Worksheet">
			<!-- sheet name -->
			<xsl:attribute name="ss:Name">
			...
			<xsl:element name="Table">
				...
				<!-- start extract content
				-->
				<xsl:call-template name="extractTypeContent">
					<xsl:with-param name="pContent" select="$pContent" />
					<xsl:with-param name="pMode">ADD</xsl:with-param>
				</xsl:call-template>
								<xsl:call-template name="extractTypeContent">
					<xsl:with-param name="pContent" select="$pContent" />
					<xsl:with-param name="pMode">CHANGE</xsl:with-param>
				</xsl:call-template>
				<xsl:call-template name="extractTypeContent">
					<xsl:with-param name="pContent" select="$pContent" />
					<xsl:with-param name="pMode">DELETE</xsl:with-param>
				</xsl:call-template>
	...
	<xsl:template name="extractTypeContent">
		<!-- start parameter -->
		<xsl:param name="pContent" />
		...
		<xsl:variable name="sTitleID4">mode</xsl:variable>
		<!-- end declarations -->
			<xsl:for-each select="//child::*/child::*[local-name() = $pMode ]/child::*[local-name() = $pContent ]">
				...
				<xsl:element name="Row">
					...
					<xsl:call-template name="generateTableCell">
						<xsl:with-param name="pColumn" select="$sColID4" />
						<xsl:with-param name="pContent" select="$pMode" />
						<xsl:with-param name="pDataType" select="$sDataType" />
					</xsl:call-template>
				</xsl:element>
			</xsl:for-each>
	...
	<xsl:template name="extractNamingRules">
		...
		<xsl:element name="Worksheet">
			...
			<xsl:element name="Table">
				...
				<!-- start extract content-->
				<xsl:for-each
					select="//child::*/child::*[local-name() = 'TcNamingRule' and @generateCounters = 'true']/child::*[local-name() = 'TcPattern']">
					...
					<xsl:element name="Row">
						...
						<xsl:call-template name="generateTableCell">
							<xsl:with-param name="pColumn" select="$sColID5" />
							<xsl:with-param name="pContent"
								select="parent::*/child::*/@initialValue" />
							<xsl:with-param name="pDataType" select="$sDataType" />
						</xsl:call-template>
						<xsl:call-template name="generateTableCell">
							<xsl:with-param name="pColumn" select="$sColID6" />
							<xsl:with-param name="pContent"
								select="parent::*/child::*/@maximumValue" />
							<xsl:with-param name="pDataType" select="$sDataType" />
						</xsl:call-template>
					</xsl:element>
				</xsl:for-each>
	...
	<xsl:template name="extractAttributes">
		...
		<xsl:variable name="sTitleID19">Mode</xsl:variable>
		<!-- end declarations -->
		<xsl:element name="Worksheet">
			<!-- sheet name -->
			<xsl:attribute name="ss:Name">
			...
			<xsl:element name="Table">
				...
				<xsl:element name="Row">
					...
					<xsl:call-template name="generateTableCell">
						<xsl:with-param name="pColumn" select="$sColID19" />
						<xsl:with-param name="pContent" select="$sTitleID19" />
						<xsl:with-param name="pDataType" select="$sDataType" />
					</xsl:call-template>
				</xsl:element>
				<!-- end header line -->
				<!-- start extract content-->
				<xsl:call-template name="extractAttributeContent">
					<xsl:with-param name="pContent" select="$pContent" />
					<xsl:with-param name="pMode">ADD</xsl:with-param>
				</xsl:call-template>
								<xsl:call-template name="extractAttributeContent">
...
<xsl:template name="extractAttributeContent">
		<!-- start parameter -->
		<xsl:param name="pContent" />
		<xsl:param name="pMode" />
		<!-- end parameter -->
				...
				<!-- start extract content
								<xsl:for-each
					select="//child::*/child::*[local-name() = $pMode ]/child::*/child::*[local-name() = 'TcAttribute']">

				-->
				<xsl:for-each select="//child::*/child::*[local-name() = $pMode ]/child::*/child::*[local-name() = $pContent ]">
					<xsl:sort select="@parentTypeName" />
					<xsl:sort select="@typeName" />
					<xsl:sort select="@typeClassName" />
					<xsl:element name="Row">
	...
	<xsl:template name="extractTypeDisplayRules">
		...
		<xsl:variable name="sTitleID4">description</xsl:variable>
		<!-- end declarations -->
		<xsl:element name="Worksheet">
			<!-- sheet name -->
			<xsl:attribute name="ss:Name">
