...
echo.
echo plmxml_export %CREDENTIALS_TMP% -xml_file=TC_RevisionRules.xml -class=RevisionRule
plmxml_export %CREDENTIALS% -xml_file=TC_RevisionRules.xml -class=RevisionRule
